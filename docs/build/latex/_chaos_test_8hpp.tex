...
\textcolor{keyword}{namespace }\hyperlink{_preproc_8hpp_a82a12e050037267a2d4015c9b0ee33c8}{CHAOS\_UNIQUE\_NAME}( chaos\_unit\_test )                             \(\backslash\)
    ...
    \{                                                                          \(\backslash\)
        ThisUnitWrapper( \hyperlink{classchaos_1_1test_1_1_fixture}{chaos::test::Fixture}& fixture ) : UnitTest( fixture ) \(\backslash\)
        \{\}                                                                     \(\backslash\)
        virtual \textcolor{keywordtype}{void} execute( \hyperlink{classchaos_1_1test_1_1_fixture}{chaos::test::Fixture}& fixture );                 \(\backslash\)
    \};                                                                         \(\backslash\)
    chaos::test::internal::TestCore chaos\_declare\_test(                        \(\backslash\)
            #path,                                                             \(\backslash\)
            \textcolor{keyword}{new} ThisUnitWrapper( fixtureType() ),                              \(\backslash\)
    );                                                                         \(\backslash\)
    \}                                                                          \(\backslash\)
