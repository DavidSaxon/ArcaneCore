...
\begin{DoxyCompactList}\small\item\em Attempts to ensure all directories in the provided path exist and are available for writing. \end{DoxyCompactList}\item 
...
\hypertarget{namespacechaos_1_1io_1_1sys_ad3693908f4b5615a25242afd013b2da9}{\index{chaos\-::io\-::sys@{chaos\-::io\-::sys}!exists@{exists}}
...
)}}\label{namespacechaos_1_1io_1_1sys_ad3693908f4b5615a25242afd013b2da9}
...
\end{DoxyReturn}
\hypertarget{namespacechaos_1_1io_1_1sys_aebd1713fea3c99cb2429e60abe5c0d80}{\index{chaos\-::io\-::sys@{chaos\-::io\-::sys}!is\-\_\-file@{is\-\_\-file}}
...
\item[{const {\bf chaos\-::io\-::sys\-::\-Path} \&}]{path}
\end{DoxyParamCaption}
)}}\label{namespacechaos_1_1io_1_1sys_aebd1713fea3c99cb2429e60abe5c0d80}
...
\end{DoxyNote}
\hypertarget{namespacechaos_1_1io_1_1sys_a9bed6e498770ad91f604b9dc4eead217}{\index{chaos\-::io\-::sys@{chaos\-::io\-::sys}!is\-\_\-directory@{is\-\_\-directory}}
...
\item[{const {\bf chaos\-::io\-::sys\-::\-Path} \&}]{path}
\end{DoxyParamCaption}
)}}\label{namespacechaos_1_1io_1_1sys_a9bed6e498770ad91f604b9dc4eead217}
...
Attempts to ensure all directories in the provided path exist and are available for writing. 

If any directories in this path do not exist this operation will attempt to create them. If the given path cannot be validated this will fail with an exception.
...
p << \textcolor{stringliteral}{"example"} << \textcolor{stringliteral}{"path"} << \textcolor{stringliteral}{"to"} << \textcolor{stringliteral}{"directory"};
\hyperlink{namespacechaos_1_1io_1_1file_a85365416303132fc0e8691af65fdcf41}{chaos::io::sys::validate\_path}( p );
\textcolor{comment}{// this will attempt to ensure example/path/to/directory exists.}
\end{DoxyCode}
