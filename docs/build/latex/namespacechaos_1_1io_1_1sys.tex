...
If the path does not exist this operation will return false. 
\end{DoxyNote}
\hypertarget{namespacechaos_1_1io_1_1sys_ad9a4b38dc5e32ab7b0ccf0153d7ed388}{\index{chaos\-::io\-::sys@{chaos\-::io\-::sys}!list@{list}}
...
\item[{bool}]{resolve\-\_\-links = {\ttfamily false}}
\end{DoxyParamCaption}
)}}\label{namespacechaos_1_1io_1_1sys_ad9a4b38dc5e32ab7b0ccf0153d7ed388}


Lists the file system paths located under the given path. 

This operation performs a similar function to the {\ttfamily ls} command on Linux, or the {\ttfamily dir} command on Windows. An empty vector will be returned if the given path does not exist or is a file.


\begin{DoxyParams}{Parameters}
{\em path} & The path to list sub paths of. \\
\hline
{\em resolve\-\_\-links} & Controls whether the operation will follow symbolic links and treat them as the path it points to or if the path to a symbolic link should be treated as the absolute path to the link itself (default behavior). This argument has no effect on Windows platforms since symbolic linking is not supported by Windows. \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
std\-::vector that contains the sub paths. 
\end{DoxyReturn}
\hypertarget{namespacechaos_1_1io_1_1sys_a1d30db6ee911af61479ed4af9f963d1c}{\index{chaos\-::io\-::sys@{chaos\-::io\-::sys}!list\-\_\-rec@{list\-\_\-rec}}
...
\item[{bool}]{resolve\-\_\-links = {\ttfamily false}}
\end{DoxyParamCaption}
)}}\label{namespacechaos_1_1io_1_1sys_a1d30db6ee911af61479ed4af9f963d1c}


Lists all descendant file system paths located under the given path. 

This operation returns a vector similar to that of \hyperlink{namespacechaos_1_1io_1_1sys_ad9a4b38dc5e32ab7b0ccf0153d7ed388}{list()}, except any sub paths that are also directories are traversed and so on, so that this function returns all paths that are a descendant of the given path.


\begin{DoxyParams}{Parameters}
{\em path} & The path to list all descendant paths of. \\
\hline
{\em resolve\-\_\-links} & Controls whether the operation will follow symbolic links and treat them as the path it points to or if the path to a symbolic link should be treated as the absolute path to the link itself (default behavior). This argument has no effect on Windows platforms since symbolic linking is not supported by Windows. \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
std\-::vector that contains the the descendant paths. 
\end{DoxyReturn}
\hypertarget{namespacechaos_1_1io_1_1sys_a6bcdadf916b110395f4a2627c049da11}{\index{chaos\-::io\-::sys@{chaos\-::io\-::sys}!create\-\_\-directory@{create\-\_\-directory}}
