...
public:
    ...
    std::vector< chaos::gfx::Vector4 > vecs;
    std::vector< chaos::gfx::Vector4 > mul;
    std::vector< chaos::gfx::Vector4 > results;
    ...
    {
        vecs.push_back( chaos::gfx::Vector4() );
        mul.push_back( chaos::gfx::Vector4() );
        results.push_back( chaos::gfx::Vector4() );

        vecs.push_back( chaos::gfx::Vector4() );
        mul.push_back( chaos::gfx::Vector4( 1.0F ) );
        results.push_back( chaos::gfx::Vector4() );
        ...
        vecs.push_back( chaos::gfx::Vector4( -1.0F, 2.0F, -3.0F, 4.0F ) );
        mul.push_back( chaos::gfx::Vector4( 3.0F, -2.0F, -1.0F, 4.0F ) );
        results.push_back( chaos::gfx::Vector4( -3.0F, -4.0F, 3.0F, 16.0F ) );

        vecs.push_back( chaos::gfx::Vector4( 0.4F, -2.556F, 0.005F, -0.433F ) );
        mul.push_back( chaos::gfx::Vector4( -0.5F, -1.56F, 2.87F, 1.245F ) );
        results.push_back( chaos::gfx::Vector4(
...
CHAOS_TEST_UNIT_FIXTURE( vector_multiplication, VectorMultiplicationFixture )
{
    ...
    for ( std::size_t i = 0; i < fixture->vecs.size(); ++i )
    {
        chaos::gfx::Vector4 v( fixture->vecs[ i ] * fixture->mul[ i ] );
