...
ARC_TEST_UNIT(negation)
{
    ...
    arc::gm::Matrix34f m2 = -m1;
    ARC_CHECK_EQUAL(m2[0][0],   0.0F);
    ARC_CHECK_EQUAL(m2[0][1],  -1.0F);
    ARC_CHECK_EQUAL(m2[0][2],  -2.0F);
    ARC_CHECK_EQUAL(m2[0][3],  -3.0F);
    ARC_CHECK_EQUAL(m2[1][0],  -4.0F);
    ARC_CHECK_EQUAL(m2[1][1],  -5.0F);
    ARC_CHECK_EQUAL(m2[1][2],  -6.0F);
    ARC_CHECK_EQUAL(m2[1][3],  -7.0F);
    ARC_CHECK_EQUAL(m2[2][0],  -8.0F);
    ARC_CHECK_EQUAL(m2[2][1],  -9.0F);
    ARC_CHECK_EQUAL(m2[2][2], -10.0F);
    ARC_CHECK_EQUAL(m2[2][3], -11.0F);
