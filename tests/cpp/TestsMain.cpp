...
void generate_file_system_objects()
{
    ...
    arc::str::UTF8String generate_path(
...
void destroy_file_system_objects()
{
    ...
    arc::str::UTF8String destroy_path(
...
int main(int argc, char* argv[])
{
    ...
    arc::test::register_global_fixture(init_py_runtime, end_py_runtime);
    arc::test::register_global_fixture(destroy_file_system_objects, NULL);
    arc::test::register_global_fixture(
        generate_file_system_objects,
        destroy_file_system_objects
    );

    // run tests
    return arc::test::deferred_main(argc, argv);
}
