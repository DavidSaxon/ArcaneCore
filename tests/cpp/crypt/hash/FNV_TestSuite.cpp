...
ARC_TEST_MODULE(crypt.hash.FNV)
...
{
    {
        ...
        ARC_CHECK_EQUAL(
            arc::crypt::hash::fnv1a_32(
                bytes.get_raw(),
                bytes.get_byte_length() - 1
            ),
            2054747410U
        );
    }
...

    {
        ...
        arc::uint32 accumlated_hash = arc::crypt::hash::fnv1a_32(
            part1.get_raw(),
            part1.get_byte_length() - 1
        );
        accumlated_hash = arc::crypt::hash::fnv1a_32(
            part2.get_raw(),
...
ARC_TEST_UNIT(fnv1a_64)
{
...

    {
        ...
        arc::uint64 accumlated_hash = arc::crypt::hash::fnv1a_64(
            part1.get_raw(),
            part1.get_byte_length() - 1
        );
        accumlated_hash = arc::crypt::hash::fnv1a_64(
            part2.get_raw(),
            part2.get_byte_length() - 1,
            accumlated_hash
        );
