...
ARC_TEST_MODULE(crypt.hash.Spooky)
...
ARC_TEST_UNIT(spooky_128)
{
    ...
    ARC_CHECK_EQUAL(hash1, 6374583358040983489UL);
    ARC_CHECK_EQUAL(hash1, 6374583358040983489UL);
}
...
ARC_TEST_UNIT(spooky_32)
{
    constexpr std::size_t buffer_size = 512;
    static const arc::uint64 expected[buffer_size] = {
