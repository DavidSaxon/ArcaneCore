...
ARC_TEST_MODULE(config.visitors.Path)
...
ARC_TEST_UNIT_FIXTURE(path_v, PathVFixture)
{
    ...
    {
        arc::config::Document doc(&fixture->valid[i]);
        ARC_CHECK_EQUAL(
            *doc.get("key", arc::config::PathV::instance()),
            fixture->results[i]
        );
    }
...
ARC_TEST_UNIT_FIXTURE(external_reference, ExternalReferenceFixture)
{
    ...
    {
        arc::config::Document doc(&fixture->base);
        ARC_CHECK_THROW(
            *doc.get("direct", arc::config::PathV::instance()),
            arc::ex::TypeError
        );
        ARC_CHECK_THROW(
            *doc.get("indirect", arc::config::PathV::instance()),
            arc::ex::TypeError
        );
    }
    ...
    {
        arc::config::Document doc(&fixture->base);
        arc::config::Document ext_doc(&fixture->valid);
        ARC_CHECK_EQUAL(
            *doc.get("direct", arc::config::PathV::instance(&ext_doc)),
            fixture->result_1
        );
        ARC_CHECK_EQUAL(
            *doc.get("indirect", arc::config::PathV::instance(&ext_doc)),
            fixture->result_2
        );
    }
    ...
    {
        arc::config::Document doc(&fixture->base);
        arc::config::Document ext_doc(&fixture->invalid);
        ARC_CHECK_THROW(
            *doc.get("direct", arc::config::PathV::instance(&ext_doc)),
            arc::ex::TypeError
        );
