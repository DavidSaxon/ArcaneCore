...
ARC_TEST_MODULE(config.visitors.String)
...
ARC_TEST_UNIT_FIXTURE(utf8string_v, UTF8StringVFixture)
{
    ARC_TEST_MESSAGE("Checking against valid data");
    {
        ...
        ARC_CHECK_EQUAL(
            *doc.get("key_1", arc::config::UTF8StringV::instance()),
            arc::str::UTF8String("")
        );
        ARC_CHECK_EQUAL(
            *doc.get("key_2", arc::config::UTF8StringV::instance()),
...
ARC_TEST_UNIT_FIXTURE(utf8string_vector_v, UTF8StringVectorVFixture)
{
    ARC_TEST_MESSAGE("Checking against valid data");
    {
        ...
        std::vector<arc::str::UTF8String> value_1(
            *doc.get("key_1", arc::config::UTF8StringVectorV::instance()));
        ...
        std::vector<arc::str::UTF8String> value_2(
            *doc.get("key_2", arc::config::UTF8StringVectorV::instance()));
        ...
        std::vector<arc::str::UTF8String> empty(
            *doc.get("empty", arc::config::UTF8StringVectorV::instance()));
