 ...
 * \author David Saxon
 */
#ifndef ARCANECORE_CONFIG_VARIANT_HPP_
#define ARCANECORE_CONFIG_VARIANT_HPP_
...
/*!
 * \brief A derived implementation of Document which supports loading config
 *        data from multiple variants of a file path.
 *
