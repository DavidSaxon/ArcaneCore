 ...
 * \author David Saxon
 */
#ifndef ARCANECORE_CONFIG_VISITORS_PRIMITIVE_HPP_
#define ARCANECORE_CONFIG_VISITORS_PRIMITIVE_HPP_
 ...
 *        arc::config::Document.
 */
class BoolV : public arc::config::Visitor<bool>
{
public:
 ...
 *        arc::config::Document.
 */
class BoolVectorV : public arc::config::Visitor<std::vector<bool>>
{
public:
...
class IntV : public arc::config::Visitor<IntType>
{
public:
            ...
            arc::str::UTF8String& error_message)
    {
        ...
        arc::config::Visitor<IntType>::m_value =
 ...
 */
template<typename IntType>
class IntVectorV : public arc::config::Visitor<std::vector<IntType>>
{
public:
            ...
            arc::str::UTF8String& error_message)
    {
        ...
        arc::config::Visitor<std::vector<IntType>>::m_value = temp;
        return true;
    }
};
...
public:
            ...
            arc::str::UTF8String& error_message)
    {
        ...
        arc::config::Visitor<FloatType>::m_value =
 ...
 *        numbers from a arc::config::Document.
 *
 *
 * \tparam FloatType The floating point type that values should be retrieve as
 ...
 */
template<typename FloatType>
class FloatVectorV : public arc::config::Visitor<std::vector<FloatType>>
{
public:
            ...
            arc::str::UTF8String& error_message)
    {
        ...
        // no errors, use the temp value
        arc::config::Visitor<std::vector<FloatType>>::m_value = temp;
        return true;
    }
};
