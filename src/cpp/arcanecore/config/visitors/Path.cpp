...
PathV::PathV(arc::config::Document* external_document)
    :
    arc::config::Visitor<arc::io::sys::Path>(),
...
PathV& PathV::instance(arc::config::Document* external_document)
{
    static PathV v;
...
arc::config::Document* PathV::get_external_document() const
{
    return m_external;
}

void PathV::set_external_document(arc::config::Document* external_document)
{
    m_external = external_document;
}
